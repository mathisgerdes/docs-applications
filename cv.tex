...
\begin{itemize}[left=0pt, itemsep=5pt]
    ...
    {\footnotesize \textbf{Talk}: Flow-based Sampling for Lattice Field Theory.”} \dateright{{\color{black}\textit{Trento}}}
    
    \item {\href{https://indico.phys.sinica.edu.tw/event/133/}{Lattice Field Theory and Machine Learning}} \dateright{ 5-6 Dec, 2024} \\
    {\footnotesize \textbf{Talk}: Continuous normalizing flows for gauge theories.”} \dateright{{\color{black}\textit{Trento}}}
